...
- While the content behind moves relative to the glass (a fixed bar over a scrolling page), WebGL glass switches to native blur and the lens fades back when scrolling stops: a JS-painted copy would lag behind iOS compositor scrolling.
