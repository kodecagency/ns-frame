...
export const SECTIONS: Section[] = [
  ...
  { id: 'por-que', name: 'Por qué', sub: 'Antes y después', icon: 'M4 10h12M10 4v12' },
  { id: 'forma', name: 'Formas', sub: 'Una línea', icon: 'M7 2.5h6l4.5 4.5v6L13 17.5H7L2.5 13V7Z', nav: true },
  { id: 'bordes', name: 'Bordes', sub: 'Degradados y luz', icon: 'M3 14V8a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v6M3 17h14', nav: true },
